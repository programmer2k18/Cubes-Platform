    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{route('bookingAnalysis')}}" class="nav-link">Home</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="{{route('profile',request()->session()->get('admin')->id)}}" class="d-block">
                        {{request()->session()->get('admin')->name}}
                    </a>
                </div>
            ...
            <nav class="mt-2" style="padding-bottom: 17px">
                <ul class="nav nav-pills nav-sidebar flex-column classActive" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{route('forecastingView')}}" class="nav-link">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Forecasting
                                <i class="right fas fa-angle-right"></i>
...
--}}
                    ...
                    <li class="nav-item">
                        <a href="{{route('getAllReviews')}}" class="nav-link">
                            ...
                            <p>
                                Reviews
                                <span class="badge badge-info right">@yield('reviews_count')</span>
                            </p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item has-treeview">
                        <a href="#" class="nav-link">
                            <i class="fas fa-ad"  style="margin-left: 5px"></i>
                            <p  style="margin-left: 9px">
                                Offers/Promotions
                                <i class="fas fa-angle-right right"></i>
                            </p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('generalOffers')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>General</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('customizedOffers')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Customized</p>
                                </a>
                            </li>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-4">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('bookingAnalysis')}}">Home</a></li>
