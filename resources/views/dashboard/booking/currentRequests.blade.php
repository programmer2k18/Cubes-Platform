@extends('welcome')
@section('title','Booked Now')

@section('content-header','Current Booking Requests that are happening now for your coworking space')

@section('content-breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('currentBookedRequests')}}">Current Booking Requests</a></li>
@endsection
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Booked Now</h3>
                                ...
                                <div class="card  collapsed-card" style="background-color: #1e2b37;color: white">
                                    <div class="card-header">
                                        ...
                                        <div   style="float: right">
                                            <h3 class="card-title">Remaining Time: {{\Carbon\Carbon::now()->diffAsCarbonInterval($request->to)}}</h3>
                                        </div>
                                        <!-- /.card-tools -->
                                    </div>
                                    <!-- /.card-header -->
