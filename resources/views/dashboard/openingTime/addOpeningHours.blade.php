...
@section('content-breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('addOpeningTimeForm')}}">Add Opening Time</a></li>
@endsection
    ...
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Add Opening Time</h3>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('addOpeningTime')}}">
